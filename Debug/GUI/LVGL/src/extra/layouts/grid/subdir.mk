...
C_DEPS += \
./GUI/LVGL/src/extra/layouts/grid/lv_grid.d 


# Each subdirectory must supply rules for building sources it contributes
GUI/LVGL/src/extra/layouts/grid/%.o GUI/LVGL/src/extra/layouts/grid/%.su GUI/LVGL/src/extra/layouts/grid/%.cyclo: ../GUI/LVGL/src/extra/layouts/grid/%.c GUI/LVGL/src/extra/layouts/grid/subdir.mk
...
clean: clean-GUI-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-grid

clean-GUI-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-grid:
	-$(RM) ./GUI/LVGL/src/extra/layouts/grid/lv_grid.cyclo ./GUI/LVGL/src/extra/layouts/grid/lv_grid.d ./GUI/LVGL/src/extra/layouts/grid/lv_grid.o ./GUI/LVGL/src/extra/layouts/grid/lv_grid.su

.PHONY: clean-GUI-2f-LVGL-2f-src-2f-extra-2f-layouts-2f-grid
